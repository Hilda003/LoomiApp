...
class DetailMaterialAdapter(
    ...
    private val sortedSection = sections.sortedBy { it.order }
    ...
    inner class SectionViewHolder(val binding: ItemSectionBinding) :
        ...
        fun bind(section: Section) {
            ...
            ProgressManager.isSectionUnlocked(context, section, sortedSection) { isUnlocked ->
                ...
                binding.root.setOnClickListener {
                    if (!section.isLocked && section.content.isNotEmpty()) {
                        ...
                        intent.putExtra("SECTION_ID", section.docId)
